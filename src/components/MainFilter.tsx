  ...
  return (
    <div className="mt-[52px] w-[688px] border border-[#DEE2E6] rounded-[10px] flex items-center justify-between py-3">
      <div className="relative">
        ...
        {dropDepartments && (
          <div className="absolute pt-10 pl-[30px] pb-[25px] gap-y-[22px] flex flex-col top-10 left-0 bg-white dark:text-black border-purple border rounded-[10px] w-[688px]">
      ...
      <div className="relative">
        ...
        {dropPriorities && (
          <div className="absolute pt-10 pl-[30px] pb-[25px] gap-y-[22px] flex flex-col top-10 left-0 transform -translate-x-[280px] z-10 bg-white dark:text-black border-purple border rounded-[10px] w-[688px]">
